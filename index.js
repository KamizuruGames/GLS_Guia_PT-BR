...
const Vec3 = require('tera-vec3'),
	...
	FirstBossActions = {
		106: { msg: 'ATAQUE PESADO' },
		107: { msg: 'ATAQUE ATRAS' },
		109: { msg: 'PEDRAS (PEQUENAS)' },
		110: { msg: 'PEDRAS (GRANDES)' },
		301: { msg: 'FLOR DE STUN' },
		309: { msg: '1 FLOR' },
		310: { msg: '2 FLORES' },
		116: { msg: 'GRANDE ATAQUE EM AREA!!' },
		312: { msg: 'FLOR DE OURO!!' }
	}, SecondBossActions = {
		105: { msg: 'GIRO' },
		113: { msg: 'STUN VINDO' },
		114: { msg: 'FIQUE DENTRO' },
		116: { msg: 'FRENTE E ENTAO ATRAS' },
		301: { msg: 'FORA + ESQUIVA' },
		302: { msg: 'DENTRO + ESQUIVA' }
	}, ThirdBossActions = {
		118: { msg: 'ATAQUE TRIPLO NA FRENTE' }, // para Tank
		143: { msg: 'ESQUERDA ATRAS' },
		145: { msg: 'ESQUERDA ATRAS' },
		146: { msg: 'ESQUERDA ATRAS (PULSE)', sign_degrees: 330, sign_distance: 320 },
		154: { msg: 'ESQUERDA ATRAS (PULSE)', sign_degrees: 330, sign_distance: 320 },
		144: { msg: 'DIREITA ATRAS' },
		147: { msg: 'DIREITA ATRAS' },
		148: { msg: 'DIREITA ATRAS (PULSES)', sign_degrees: 30, sign_distance: 320 },
		155: { msg: 'DIREITA ATRAS (PULSES)', sign_degrees: 30, sign_distance: 320 },

		139: { msg: 'ESQUERDA SEGURO', sign_degrees: 270, sign_distance: 200 }, //151 //clockwise (swinging head) king hitting right
		150: { msg: 'ESQUERDA SEGURO!', sign_degrees: 270, sign_distance: 200 }, //151 //clockwise (landing) king hit right
		141: { msg: 'DIREITA SEGURO', sign_degrees: 90, sign_distance: 200 }, //153 //Counterclockwise (swinging head) King hit left
		152: { msg: 'DIREITA SEGURO!', sign_degrees: 90, sign_distance: 200 }, //153 //Counterclockwise (landing) King hit left

		161: { msg: 'ATRAS E ENTAO FRENTE' },
		162: { msg: 'ATRAS E ENTAO FRENTE' },
		213: { msg: 'RABO' },
		215: { msg: 'RABO!!' },

		300: { msg: 'ESQUIVA!! (DESPERTAR 1)' },
		360: { msg: 'EXPLOSAO!!' },
		399: { msg: 'ESQUIVA!! (DESPERTAR 2)' }
	};
...
module.exports = function GrottoOfLostSoulsGuide(mod) {
	...
	function sLoadTopo(event) {
		if (event.zone === mapID[0]) {
			insidemap = true;
			mod.command.message('Bem Vindo a ' + 'Grotto of Lost Souls '.clr('56B4E9') + '[NM]'.clr('E69F00'));
			load();
		} else if (event.zone === mapID[1]) {
			insidemap = true;
			mod.command.message('Bem Vindo a ' + 'Grotto of Lost Souls '.clr('56B4E9') + '[HM]'.clr('00FFFF'));
			load();
		} else if (event.zone === mapID[2]) {
			insidemap = true;
			mod.command.message('Bem Vindo a ' + 'Grotto of Lost Souls '.clr('56B4E9') + '[HM] (7 man)'.clr('00FFFF'));
			load();
		} else unload();
	}
